...
public class AdditionMain {
    ...
    public static void main(String[] args) {
        ...
        Addition addition5 = (x, y) -> x + y; // return x + y;와 같다.

        Viewer viewer1 = (viewData) -> { // view메소드가 있는 것
        ...
        // ***** 람다식 핵심조건 *****
        // 인터페이스 안에 "딱 하나"의 추상메소드만 정의되어 있어야 한다!!
